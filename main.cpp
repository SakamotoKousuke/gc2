...
extern IMGUI_IMPL_APILRESULTImGui_ImplWin32_WndProcHandler(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam);
...
// こういうもんである
	...
	ImGui_ImpIDX12_Shutdown();
	ImGui_ImpIWin32_Shutdown();
